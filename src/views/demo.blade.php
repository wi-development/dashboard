@extends('dashboard::layouts.demo-master')
...
@section('scripts.footer')
		<!--Morris.js [ OPTIONAL ] -->
<script src="{{config('wi.dashboard.theme_path')}}/vendor/morris-js/morris.min.js"></script>
<script src="{{config('wi.dashboard.theme_path')}}/vendor/morris-js/raphael-js/raphael.min.js"></script>


<!--Sparkline [ OPTIONAL ]-->
<script src="{{config('wi.dashboard.theme_path')}}/vendor/sparkline/jquery.sparkline.min.js"></script>

<!--Skycons [ OPTIONAL ]-->
<script src="{{config('wi.dashboard.theme_path')}}/vendor/skycons/skycons.min.js"></script>

<!--Specify page [ SAMPLE ] -->
<script src="{{config('wi.dashboard.theme_path')}}/js/demo/dashboard.js"></script>
@endsection